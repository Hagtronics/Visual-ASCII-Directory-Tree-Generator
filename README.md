...
Currently the default ignore list is: `IGNORE_LIST = ['.git', '__pycache__', '.mypy_cache', '.vscode', '.ipynb_checkpoints']`  
...
The rest of the GUI code, etc. here is total freeware.  
